...
// -----------------------------------------------------------------------------
//  REMITTANCES – tablas base + relaciones
// -----------------------------------------------------------------------------
diesel::table! {
    use diesel::sql_types::*;
    use crate::enums::diesel_exports::*;

    /// Tabla principal de remesas
    remittances (id) {
        id                   -> Uuid,
        merchant_id          -> Text,
        profile_id           -> Text,
        ...
        source_amount        -> Nullable<Int8>,
        destination_amount   -> Nullable<Int8>,
...
diesel::table! {
    ...
    remittance_payments (remittance_id) {
        remittance_id   -> Uuid,
        payment_id      -> Nullable<Text>,
        connector_txn_id-> Nullable<Text>,
...
diesel::table! {
    ...
    remittance_payouts (remittance_id) {
        remittance_id     -> Uuid,
        payout_id         -> Nullable<Text>,
        connector_txn_id  -> Nullable<Text>,
        status            -> Nullable<Text>,
        remittance_method -> Nullable<Text>,
        created_at        -> Nullable<Timestamptz>,
        updated_at        -> Nullable<Timestamptz>,
    }
}
...
diesel::joinable!(remittance_payments -> remittances (remittance_id));
diesel::joinable!(remittance_payouts  -> remittances (remittance_id));
