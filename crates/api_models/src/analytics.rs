...
use self::{
    ...
    remittances::{RemittanceDimensions, RemittanceDistributions, RemittanceMetrics},
...
pub struct AnalyticsRequest {
    ...
    pub remittance: Option<GetRemittanceMetricRequest>, // Integración de remesas
...
// ──────────────────────────────────────────────────────────────
// Integración de Remesas
// ──────────────────────────────────────────────────────────────

#[derive(Clone, Debug, serde::Deserialize, serde::Serialize)]
#[serde(rename_all = "camelCase")]
pub struct RemittanceDistributionBody {
    pub distribution_for: RemittanceDistributions,
    pub distribution_cardinality: QueryLimit,
}

#[derive(Clone, Debug, serde::Deserialize, serde::Serialize)]
#[serde(rename_all = "camelCase")]
pub struct GetRemittanceMetricRequest {
    pub time_series: Option<TimeSeries>,
    pub time_range: TimeRange,
    #[serde(default)]
    pub group_by_names: Vec<RemittanceDimensions>,
    // Se asume que en el módulo remittances ya está definido el tipo de filtros;
    // si no, se puede definir en ese módulo.
    #[serde(default)]
    pub filters: remittances::RemittanceFilters,
    pub metrics: HashSet<RemittanceMetrics>,
    pub distribution: Option<RemittanceDistributionBody>,
    #[serde(default)]
    pub delta: bool,
}

// ──────────────────────────────────────────────────────────────
// Solicitudes y respuestas para filtros de remesas
// ──────────────────────────────────────────────────────────────

#[derive(Debug, serde::Deserialize, serde::Serialize)]
#[serde(rename_all = "camelCase")]
pub struct GetRemittanceFilterRequest {
    pub time_range: TimeRange,
    #[serde(default)]
    pub group_by_names: Vec<RemittanceDimensions>,
}
...
#[serde(rename_all = "camelCase")]
pub struct RemittanceFiltersResponse {
    pub query_data: Vec<RemittanceFilterValue>,
}

#[derive(Debug, serde::Serialize, Eq, PartialEq)]
#[serde(rename_all = "camelCase")]
pub struct RemittanceFilterValue {
    pub dimension: RemittanceDimensions,
