...
"#,
    ...
    tags(
        ...
        (name = "Remittances", description = "Create and manage international money transfers"),
...
routes::remittances::remittances_create,
routes::remittances::remittances_retrieve,
routes::remittances::remittances_update,
routes::remittances::remittances_pay,
routes::remittances::remittances_cancel,
routes::remittances::remittances_list,
routes::remittances::remittances_quote,
routes::remittances::remittances_sync,
routes::remittances::remittances_sync_merchant,
routes::remittances::remittances_recover,
routes::remittances::remittances_webhook,
    ...
    components(schemas(
        ...
        api_models::remittances::RemittanceRequest,
        api_models::remittances::RemittancePayRequest,
        api_models::remittances::RemittanceUpdateRequest,
        api_models::remittances::RemittancesRetrieveRequest,
        api_models::remittances::RemittanceListRequest,
        api_models::remittances::RemittanceManualUpdateRequest,
        api_models::remittances::RemittanceSyncRequest,
        api_models::remittances::RemittanceQuoteRequest,
        api_models::remittances::RemittanceResponse,
        api_models::remittances::RemittanceListResponse,
        api_models::remittances::RemittanceSyncResponse,
        api_models::remittances::RemittanceSyncResult,
        api_models::remittances::RemittanceQuoteResponse,
        api_models::remittances::SenderDetails,
        api_models::remittances::BeneficiaryDetails,
        api_models::remittances::CustomerDetails,
        api_models::remittances::ExchangeRateInfo,
        api_models::remittances::PayoutMethodData,
        api_models::remittances::BankTransferData,
        api_models::remittances::CardPayoutData,
        api_models::remittances::WalletPayoutData,
        api_models::remittances::CashPickupData,
        api_models::remittances::ComplianceStatus,
        api_models::remittances::RequiredDocument,
        api_models::remittances::RemittanceStatus,
        api_models::remittances::RemittancePurpose,
        api_models::remittances::WalletType,
        api_models::remittances::BankAccountType,
        api_models::remittances::ComplianceCheckStatus,
        api_models::remittances::DocumentStatus,
